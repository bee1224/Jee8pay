...
/** RYO allowlisted log-value sanitizer. Raw Provider payloads must never be passed here for logging. */
public final class RyoLogSanitizer {
    ...
    private RyoLogSanitizer() {
    }

    public static String sanitize(String value, RyoNormalMchParams params) {
        try {
