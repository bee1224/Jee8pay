...
/** JHD allowlisted log-value sanitizer. Raw Provider payloads must never be passed here for logging. */
public final class JhdLogSanitizer {
    ...
    private JhdLogSanitizer() {
    }

    public static String sanitize(String value, JhdNormalMchParams params) {
        try {
