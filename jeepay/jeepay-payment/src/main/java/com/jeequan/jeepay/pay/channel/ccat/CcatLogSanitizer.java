...
/** CCAT allowlisted log-value sanitizer. Raw Provider payloads must never be passed here for logging. */
public final class CcatLogSanitizer {
    ...
    private CcatLogSanitizer() {
    }

    public static String sanitize(String value, CcatNormalMchParams params) {
        try {
