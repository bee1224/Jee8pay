...
/** JAY allowlisted log-value sanitizer. Raw Provider payloads must never be passed here for logging. */
public final class JayLogSanitizer {
    ...
    private JayLogSanitizer() {
    }

    public static String sanitize(String value, JayNormalMchParams params) {
        try {
