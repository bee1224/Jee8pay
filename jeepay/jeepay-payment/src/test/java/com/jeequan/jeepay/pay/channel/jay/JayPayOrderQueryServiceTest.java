...
class JayPayOrderQueryServiceTest {

    private JayClient client;
    private JayMchParamsResolver paramsResolver;
    private JayPayOrderQueryService service;
    ...
    void setUp() {
        ...
        service = new JayPayOrderQueryService(client, paramsResolver);
    ...
    void rejectsLocalOrderAmountMismatch() throws Exception {
        ...
        assertThrows(JayException.class, () -> service.queryValidated(payOrder, params));
    }
    ...
    private JayPayOrderQueryService.ValidatedQuery query(String processCode) throws Exception {
