...
class JhdChannelNoticeServiceTest {
    ...
    void setUp() throws Exception {
        ...
        service = new JhdChannelNoticeService(
                new JhdPayOrderQueryService(client, paramsResolver), payOrderService, paramsResolver);
    ...
    void validPaidApnReturnsSuccessForNativeTransition() throws Exception {
        ...
        JhdChannelNoticeService.JhdNoticePayload payload = payload("test-user", "TX-001",
        ...
        ChannelRetMsg result = service.doNotice(new MockHttpServletRequest(), payload, payOrder, context,
                JhdChannelNoticeService.NoticeTypeEnum.DO_NOTIFY);
    ...
    void validDuplicatePaidApnIsFullyRevalidatedAndAcked() throws Exception {
        ...
        ChannelRetMsg result = service.doNotice(new MockHttpServletRequest(),
                ...
                payOrder, context, JhdChannelNoticeService.NoticeTypeEnum.DO_NOTIFY);
    ...
    void invalidChecksumIsRejectedBeforeProviderQuery() throws Exception {
        ...
        assertThrows(ResponseException.class, () -> service.doNotice(new MockHttpServletRequest(),
                JhdChannelNoticeService.JhdNoticePayload.parse(body.toJSONString()), payOrder, context,
                JhdChannelNoticeService.NoticeTypeEnum.DO_NOTIFY));
    ...
    void malformedPayloadAndWrongContentTypeAreRejected() {
        MockHttpServletRequest malformed = new MockHttpServletRequest("POST", "/api/pay/notify/jhd");
        ...
        MockHttpServletRequest wrongType = new MockHttpServletRequest("POST", "/api/pay/notify/jhd");
    ...
    void concurrentDuplicateLoserAcksOnlyExactCommittedTerminalIdentity() throws Exception {
        ...
        service.parseParams(request, null, JhdChannelNoticeService.NoticeTypeEnum.DO_NOTIFY);
    ...
    void parseParamsUsesCanonicalLocalOrderKeyAndSanitizedPayloadString() throws Exception {
        ...
        org.apache.commons.lang3.tuple.MutablePair<String, Object> parsed = service.parseParams(
                request, null, JhdChannelNoticeService.NoticeTypeEnum.DO_NOTIFY);
    ...
    private JhdChannelNoticeService.JhdNoticePayload payload(String apiId, String transId, String orderNo,
                                                               String amount, String status, String payAmount) {
        return JhdChannelNoticeService.JhdNoticePayload.parse(
    ...
    private JSONObject apnBody(String apiId, String transId, String orderNo, String amount,
        ...
        body.put("checksum", JhdKit.checksum(apiId, transId, amount, status, nonce));
        if (payAmount != null) {
    ...
    private static MockHttpServletRequest requestWithBody(JSONObject body) {
        MockHttpServletRequest request = new MockHttpServletRequest("POST", "/api/pay/notify/jhd");
