...
class JhdPayOrderQueryServiceTest {

    private JhdClient client;
    private JhdMchParamsResolver paramsResolver;
    private JhdPayOrderQueryService service;
    ...
    void setUp() {
        ...
        service = new JhdPayOrderQueryService(client, paramsResolver);
    ...
    void rejectsLocalOrderAmountMismatch() throws Exception {
        ...
        assertThrows(JhdException.class, () -> service.queryValidated(payOrder, params));
    }
    ...
    private JhdPayOrderQueryService.ValidatedQuery query(String processCode) throws Exception {
