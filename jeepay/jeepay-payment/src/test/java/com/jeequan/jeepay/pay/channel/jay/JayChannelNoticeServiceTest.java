...
class JayChannelNoticeServiceTest {

    private JayClient client;
    private PayOrderService payOrderService;
    private JayMchParamsResolver paramsResolver;
    private JayChannelNoticeService service;
    private JayNormalMchParams params;
    private MchAppConfigContext context;
    private PayOrder payOrder;

    @BeforeEach
    void setUp() throws Exception {
        client = mock(JayClient.class);
        payOrderService = mock(PayOrderService.class);
        paramsResolver = mock(JayMchParamsResolver.class);
        service = new JayChannelNoticeService(
                new JayPayOrderQueryService(client, paramsResolver), payOrderService, paramsResolver);

        params = new JayNormalMchParams();
    ...
    void validPaidApnReturnsSuccessForNativeTransition() throws Exception {
        ...
        JayChannelNoticeService.JayNoticePayload payload = payload("test-user", "TX-001",
        ...
        ChannelRetMsg result = service.doNotice(new MockHttpServletRequest(), payload, payOrder, context,
                JayChannelNoticeService.NoticeTypeEnum.DO_NOTIFY);
    ...
    void validDuplicatePaidApnIsFullyRevalidatedAndAcked() throws Exception {
        ...
        ChannelRetMsg result = service.doNotice(new MockHttpServletRequest(),
                ...
                payOrder, context, JayChannelNoticeService.NoticeTypeEnum.DO_NOTIFY);
    ...
    void invalidChecksumIsRejectedBeforeProviderQuery() throws Exception {
        ...
        assertThrows(ResponseException.class, () -> service.doNotice(new MockHttpServletRequest(),
                JayChannelNoticeService.JayNoticePayload.parse(body.toJSONString()), payOrder, context,
                JayChannelNoticeService.NoticeTypeEnum.DO_NOTIFY));
    ...
    void malformedPayloadAndWrongContentTypeAreRejected() {
        MockHttpServletRequest malformed = new MockHttpServletRequest("POST", "/api/pay/notify/jay");
        ...
        MockHttpServletRequest wrongType = new MockHttpServletRequest("POST", "/api/pay/notify/jay");
    ...
    void concurrentDuplicateLoserAcksOnlyExactCommittedTerminalIdentity() throws Exception {
        ...
        service.parseParams(request, null, JayChannelNoticeService.NoticeTypeEnum.DO_NOTIFY);
    ...
    void parseParamsUsesCanonicalLocalOrderKeyAndSanitizedPayloadString() throws Exception {
        ...
        org.apache.commons.lang3.tuple.MutablePair<String, Object> parsed = service.parseParams(
                request, null, JayChannelNoticeService.NoticeTypeEnum.DO_NOTIFY);
    ...
    private JayChannelNoticeService.JayNoticePayload payload(String apiId, String transId, String orderNo,
                                                               String amount, String status, String payAmount) {
        return JayChannelNoticeService.JayNoticePayload.parse(
    ...
    private JSONObject apnBody(String apiId, String transId, String orderNo, String amount,
        ...
        body.put("checksum", JayKit.checksum(apiId, transId, amount, status, nonce));
        if (payAmount != null) {
    ...
    private static MockHttpServletRequest requestWithBody(JSONObject body) {
        MockHttpServletRequest request = new MockHttpServletRequest("POST", "/api/pay/notify/jay");
