...
class RyoPayOrderQueryServiceTest {

    private RyoClient client;
    private RyoMchParamsResolver paramsResolver;
    private RyoPayOrderQueryService service;
    ...
    void setUp() {
        ...
        service = new RyoPayOrderQueryService(client, paramsResolver);
    ...
    void rejectsLocalOrderAmountMismatch() throws Exception {
        ...
        assertThrows(RyoException.class, () -> service.queryValidated(payOrder, params));
    }
    ...
    private RyoPayOrderQueryService.ValidatedQuery query(String processCode) throws Exception {
