...
class ChiChannelNoticeServiceTest {
    ...
    void setUp() throws Exception {
        ...
        service = new ChiChannelNoticeService(
                new ChiPayOrderQueryService(client, paramsResolver), payOrderService, paramsResolver);
    ...
    void validPaidApnReturnsSuccessForNativeTransition() throws Exception {
        ...
        ChiChannelNoticeService.ChiNoticePayload payload = payload("test-user", "TX-001",
        ...
        ChannelRetMsg result = service.doNotice(new MockHttpServletRequest(), payload, payOrder, context,
                ChiChannelNoticeService.NoticeTypeEnum.DO_NOTIFY);
    ...
    void validDuplicatePaidApnIsFullyRevalidatedAndAcked() throws Exception {
        ...
        ChannelRetMsg result = service.doNotice(new MockHttpServletRequest(),
                ...
                payOrder, context, ChiChannelNoticeService.NoticeTypeEnum.DO_NOTIFY);
    ...
    void invalidChecksumIsRejectedBeforeProviderQuery() throws Exception {
        ...
        assertThrows(ResponseException.class, () -> service.doNotice(new MockHttpServletRequest(),
                ChiChannelNoticeService.ChiNoticePayload.parse(body.toJSONString()), payOrder, context,
                ChiChannelNoticeService.NoticeTypeEnum.DO_NOTIFY));
    ...
    void malformedPayloadAndWrongContentTypeAreRejected() {
        MockHttpServletRequest malformed = new MockHttpServletRequest("POST", "/api/pay/notify/chi");
        ...
        MockHttpServletRequest wrongType = new MockHttpServletRequest("POST", "/api/pay/notify/chi");
    ...
    void concurrentDuplicateLoserAcksOnlyExactCommittedTerminalIdentity() throws Exception {
        ...
        service.parseParams(request, null, ChiChannelNoticeService.NoticeTypeEnum.DO_NOTIFY);
    ...
    void parseParamsUsesCanonicalLocalOrderKeyAndSanitizedPayloadString() throws Exception {
        ...
        org.apache.commons.lang3.tuple.MutablePair<String, Object> parsed = service.parseParams(
                request, null, ChiChannelNoticeService.NoticeTypeEnum.DO_NOTIFY);
    ...
    private ChiChannelNoticeService.ChiNoticePayload payload(String apiId, String transId, String orderNo,
                                                               String amount, String status, String payAmount) {
        return ChiChannelNoticeService.ChiNoticePayload.parse(
    ...
    private JSONObject apnBody(String apiId, String transId, String orderNo, String amount,
        ...
        body.put("checksum", ChiKit.checksum(apiId, transId, amount, status, nonce));
        if (payAmount != null) {
    ...
    private static MockHttpServletRequest requestWithBody(JSONObject body) {
        MockHttpServletRequest request = new MockHttpServletRequest("POST", "/api/pay/notify/chi");
