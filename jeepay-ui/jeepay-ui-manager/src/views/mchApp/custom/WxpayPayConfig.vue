  ...
  >
    ...
    >
      <a-row v-if="vdata.mchType === 1" :gutter="16">
        ...
        <a-col span="24">
          <a-form-item label="API證書(apiclient_cert.p12)" name="cert">
        ...
        <a-col span="24">
          <a-form-item label="證書檔案(apiclient_cert.pem)" name="apiClientCert">
        ...
        <a-col span="24">
          <a-form-item label="微信側公鑰證書（pub_key.pem）" name="wxpayPublicKey">
